...
_G.packer_plugins = {
  ...
  indentLine = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/indentLine",
  ...
  ["open-browser.vim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/open-browser.vim",
  ...
  ["plantuml-previewer.vim"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/plantuml-previewer.vim",
  ...
  ["quick-scope"] = {
    loaded = true,
    path = "/home/david/.local/share/nvim/site/pack/packer/start/quick-scope",
